...
public final class ApplicationConstantsUtil {
	...
	public final static double BUSINESS_CLASS_PRICE = 0.2;
	public final static double EXTRA_PRICE = 0.1;
	
	public final static double LESS_THAN_FIVE = 0.4;
	
	public final static double LESS_THAN_TEN = 0.3;
	
	public final static double LESS_THAN_FIFTEEN = 0.2;
